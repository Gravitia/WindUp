...
ACSWhiteHall::ACSWhiteHall()
{
	...
	static ConstructorHelpers::FObjectFinder<UMaterialInstance> MaterialRef(TEXT("/Script/Engine.MaterialInstanceConstant'/Game/31_Material/MI_WhiteHole.MI_WhiteHole'"));
