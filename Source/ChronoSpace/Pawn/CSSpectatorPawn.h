...
#include "CSSpectatorPawn.generated.h"
 ...
 */
UCLASS()
class CHRONOSPACE_API ACSSpectatorPawn : public ASpectatorPawn
{
	GENERATED_BODY()
...
public:
    ...
    TObjectPtr<class UCameraComponent> DummyCamera;
    ...
    UFUNCTION(BlueprintCallable, Category = "Sync")
    void SyncWithRemoteCamera(class UCameraComponent* RemoteCamera);
